...
'og:title': 'Workflows | Hierarch.io Help Center'
'og:logo': '/logo/logo-text-dark.png'
'og:image': '/images/help-center-banner.png'
'twitter:title': 'Workflows | Hierarch.io Help Center'
'twitter:image': '/images/help-center-banner.png'
---

![](/images/workflows-banner.png)
...
* [Pipeline Changed](/workflows/triggers/pipeline-changed "Pipeline Changed")
